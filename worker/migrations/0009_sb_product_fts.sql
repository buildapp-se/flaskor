...
--
-- OBS: `wrangler d1 export` vägrar databaser med virtuella tabeller. Säkerhetskopia före en migrering: ta bort
-- sb_product_fts, exportera, kör migreringen, bygg om indexet (sista två raderna nedan). Eller använd Time Travel.
