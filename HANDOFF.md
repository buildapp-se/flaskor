...
schemaVersion: 1
status: active
currentGoal: 2026-09-15 minus och plus i tabellens Antal-kolumn (Källaren, Barskåpet), och nattens spegelkörning bekräftar D1-fixen (2 ändrade, 166 borttagna). Före det D1-skrivkvoten sprängd 2026-09-13 kl. 17:28 av tre spegelkörningar (INSERT OR REPLACE, 2 skrivningar per rad, 161 418 av 162 950); fix fd88043 deployad som Worker d081549e kl. 18:35, spegeln skriver bara ändrade rader och rensar via dumpens nummerlista. Före det tillgängligheten i Önskelistan live 2026-09-13 (commits 7fa58a7, 7ea35d3, c2258fa; migrering 0007 körd i molnet av Patrik, Worker be3892f7, spegeln körd om med sortimentskod, refresh-all 19 av 19 ur spegeln). Raderna nu 11 fast sortiment, 7 ordervara varav 2 slut hos leverantören, 1 lokalt och småskaligt. Före det spegeln 2026-09-12 (beslut 23), i drift varje natt via GitHub Actions med reserv och cache.
nextAction: Prova minus och plus i tabellvyn live. Nya ikoner från Claude Design (BACKLOG §Captured P0) är Patriks steg. Sedan öppnar Patrik Önskelistan live och läser de nya raderna (två ska säga "Ordervara · Slut hos leverantören"). Sedan ägar-QA av 2026-09-09 (namnsök, Caviste-länk, Drucket, "Kolla lagret för alla"), de tre Caviste-bildlänkarna, omskanningen. Ja eller nej på FTS5 i spegeln (BACKLOG §Spegeln P2) och på Distiller-importen.
blockers: []
...
Senast uppdaterad: 2026-09-15. **Minus och plus i tabellens Antal-kolumn** (Patriks P0 under BACKLOG §Captured). `CellarTable` fick propen `onPatch`; skickas den visar Antal `[−] 3 [+]`, samma patch som listans `CountStepper`. Källaren och Barskåpet skickar den, Önskelistan har ingen Antal-kolumn. Radklick ignorerar nu knappar, så minus öppnar inte detaljvyn. Verifierat: `npm run check` (tsc, 65 enhetstester, 67 Worker-tester, torrdeploy) och i Chromium mot `vite dev` + `wrangler dev`: plus gav 3 till 4, minus tillbaka till 3, sparat i lokal D1, adressen oförändrad, radhöjden 49 px; 19 steppers i Barskåpets tabell. **Ikonerna är kvar:** nya från Claude Design, Patriks steg.
