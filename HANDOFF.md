...
1. Claude Design: Patrik klistrar in staketet i `docs/DESIGN-BRIEF.md` på claude.ai/design. Output (tokens, piller, artboards, ikon, regler) sparas i `design/`, tokens som `design/tokens.css` med prefixet `--fl-`.
...
Läs först, helt: `CONTEXT.md`, `GRILL-STATUS.md`, `BACKLOG.md`, `HANDOFF.md`, `docs/RESEARCH.md`, `docs/DESIGN-BRIEF.md`, `design/artboards/Main.dc.html`, `seed/vinlista.tsv`. Modellen, flödena, pillerlogiken och tumregeltabellen i CONTEXT.md är beslutade och ändras inte utan att jag säger till.
