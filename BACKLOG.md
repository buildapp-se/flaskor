...
- [ ] `[P2]` (påbörjad 2026-09-23: `authhost/` deployad till Firebase Hosting `flaskor-d3762`; kvar custom domain, DNS, två konsollistor och `authDomain` i `src/config.ts`, se HANDOFF) Egen authDomain (`flaskor.buildapp.se`) så Googles inloggningsruta inte visar `flaskor-d3762.firebaseapp.com`. Receptet finns i vaultnoten Firebase Consent Screen (Beefcake).
